        ...
        public static List<NavigateIntegrate> RowList
        {
            get
            {
                var result = new List<NavigateIntegrate>
                {
                    ...
                    new NavigateIntegrate { Id = 0, ParentId = 0, Name = "SSL Certificate", TextHtml = "<i class=\"fab fa-expeditedssl\"></i> SSL Certificate", IsDivider = false, IsNavbarEnd = false, IsContent = true, NavigatePath = "/ssl-certificate/", PageTypeName = null, Sort = 1100, SitemapDate = DateTime.Parse("2021-04-28 10:26", CultureInfo.InvariantCulture), IdName = "SSL Certificate", ParentIdName = "Install" },
                };
                return result;
            }
        }
