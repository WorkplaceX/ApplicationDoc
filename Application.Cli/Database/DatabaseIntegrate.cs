        ...
        public static List<NavigateIntegrate> RowList
        {
            get
            {
                var result = new List<NavigateIntegrate>
                {
                    ...
                    new NavigateIntegrate { Id = 0, ParentId = 0, Name = "Home", TextHtml = "<i class=\"fas fa-home\"></i> Home", IsDivider = false, IsNavbarEnd = false, IsContent = true, NavigatePath = "/", PageTypeName = null, Sort = 1001, SitemapDate = DateTime.Parse("2021-04-29 03:30", CultureInfo.InvariantCulture), IdName = "Home", ParentIdName = null },
                    ...
                    new NavigateIntegrate { Id = 0, ParentId = 0, Name = "Md", TextHtml = "<i class=\"fab fa-markdown\"></i> Markdown", IsDivider = false, IsNavbarEnd = false, IsContent = true, NavigatePath = "/feature-md-markdown/", PageTypeName = null, Sort = 1002.5, SitemapDate = DateTime.Parse("2021-04-29 05:10", CultureInfo.InvariantCulture), IdName = "Md", ParentIdName = "Feature" },
        ...
        public static List<ContentIntegrate> RowList
        {
            get
            {
                var result = new List<ContentIntegrate>
                {
                    ...
                    new ContentIntegrate { Id = 0, Name = "Home", NavigateTree = "/", NavigatePath = "/", TitleHtml = "<i class=\"fas fa-home\"></i> Home", TitleLong = "Business Application Framework", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Home.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Home.html"), Sort = 1, SitemapDate = DateTime.Parse("2021-04-29 03:30", CultureInfo.InvariantCulture), IdName = "Home" },
                    ...
                    new ContentIntegrate { Id = 0, Name = "New", NavigateTree = "/feature/new/", NavigatePath = "/feature-new-application/", TitleHtml = "<i class=\"fas fa-plus-square\"></i> New Application", TitleLong = "Feature New - Create a New Application", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.New.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.New.html"), Sort = 0.25, SitemapDate = DateTime.Parse("2021-04-29 04:22", CultureInfo.InvariantCulture), IdName = "New" },
                    new ContentIntegrate { Id = 0, Name = "SSL Certificate", NavigateTree = "/install/ssl/", NavigatePath = "/ssl-certificate/", TitleHtml = "<i class=\"fab fa-expeditedssl\"></i> SSL Certificate", TitleLong = "Install and Order a SSL Cerificate with IIS", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.SSL Certificate.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.SSL Certificate.html"), Sort = 100, SitemapDate = DateTime.Parse("2021-04-29 08:34", CultureInfo.InvariantCulture), IdName = "SSL Certificate" },
                };
                return result;
            }
        }
