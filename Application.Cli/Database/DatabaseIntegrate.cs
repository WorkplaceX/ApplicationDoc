        ...
        public static List<ContentIntegrate> RowList
        {
            get
            {
                var result = new List<ContentIntegrate>
                {
                    ...
                    new ContentIntegrate { Id = 0, Name = "Code Counter", NavigateTree = "/code/counter/", NavigatePath = "/counter/", TitleHtml = "<i class=\"fas fa-mouse\"></i> Counter", TitleLong = "Hello World Counter Example", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Code Counter.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Code Counter.html"), Sort = 2, SitemapDate = DateTime.Parse("2021-05-02 01:43", CultureInfo.InvariantCulture), IdName = "Code Counter" },
                    new ContentIntegrate { Id = 0, Name = "Code Data Grid", NavigateTree = "/code/data-grid/", NavigatePath = "/data-grid/", TitleHtml = "<i class=\"fas fa-table\"></i> Data Grid", TitleLong = "From Database to DataGrid", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Code Data Grid.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Code Data Grid.html"), Sort = 3, SitemapDate = DateTime.Parse("2021-04-29 08:59", CultureInfo.InvariantCulture), IdName = "Code Data Grid" },
                    new ContentIntegrate { Id = 0, Name = "Code Hello World", NavigateTree = "/code/hello-world/", NavigatePath = "/hello-world/", TitleHtml = "<i class=\"fas fa-globe\"></i> Hello World", TitleLong = "Hello World Code Example", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Code Hello World.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Code Hello World.html"), Sort = 1, SitemapDate = DateTime.Parse("2021-05-02 01:44", CultureInfo.InvariantCulture), IdName = "Code Hello World" },
                    new ContentIntegrate { Id = 0, Name = "Config", NavigateTree = "/feature/config/", NavigatePath = "/config/", TitleHtml = "<i class=\"fas fa-cog\"></i> Config", TitleLong = "Feature Config - All Configuration", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Config.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Config.html"), Sort = 0.5, SitemapDate = DateTime.Parse("2021-05-01 03:01", CultureInfo.InvariantCulture), IdName = "Config" },
                    new ContentIntegrate { Id = 0, Name = "Excel", NavigateTree = "/feature/excel/", NavigatePath = "/excel/", TitleHtml = "<i class=\"fas fa-file-excel\"></i> Excel", TitleLong = "Feature Excel Export and Import", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Excel.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Excel.html"), Sort = 3, SitemapDate = DateTime.Parse("2021-05-01 03:01", CultureInfo.InvariantCulture), IdName = "Excel" },
                    new ContentIntegrate { Id = 0, Name = "ExternalGit", NavigateTree = "/feature/external-git/", NavigatePath = "/external-git/", TitleHtml = "<i class=\"fab fa-git-square\"></i> ExternalGit", TitleLong = "Feature ExternalGit - Bundle Multiple Applications Into One", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.ExternalGit.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.ExternalGit.html"), Sort = 100, SitemapDate = DateTime.Parse("2021-05-01 03:01", CultureInfo.InvariantCulture), IdName = "ExternalGit" },
                    ...
                    new ContentIntegrate { Id = 0, Name = "Home", NavigateTree = "/", NavigatePath = "/", TitleHtml = "<i class=\"fas fa-home\"></i> Home", TitleLong = "Business Application Framework for ASP.NET Core 5.0 ", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Home.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Home.html"), Sort = 1, SitemapDate = DateTime.Parse("2021-05-02 01:41", CultureInfo.InvariantCulture), IdName = "Home" },
                    ...
                    new ContentIntegrate { Id = 0, Name = "Integrate", NavigateTree = "/feature/integrate/", NavigatePath = "/integrate/", TitleHtml = "<i class=\"fas fa-industry\"></i> Integrate", TitleLong = "Feature Integrate - Store SQL Data in C# Code", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Integrate.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Integrate.html"), Sort = 1, SitemapDate = DateTime.Parse("2021-05-01 03:01", CultureInfo.InvariantCulture), IdName = "Integrate" },
                    new ContentIntegrate { Id = 0, Name = "Md", NavigateTree = "/feature/md/", NavigatePath = "/md-markdown/", TitleHtml = "<i class=\"fab fa-markdown\"></i> Markdown", TitleLong = "Feature Markdown - Markdown parser", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Md.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Md.html"), Sort = 2.5, SitemapDate = DateTime.Parse("2021-05-01 03:01", CultureInfo.InvariantCulture), IdName = "Md" },
                    new ContentIntegrate { Id = 0, Name = "Navigate", NavigateTree = "/feature/navigate/", NavigatePath = "/navigate-request/", TitleHtml = "<i class=\"far fa-compass\"></i> Navigate Request", TitleLong = "Feature Navigate - Navigate Request", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Navigate.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Navigate.html"), Sort = 2.25, SitemapDate = DateTime.Parse("2021-05-01 03:01", CultureInfo.InvariantCulture), IdName = "Navigate" },
                    new ContentIntegrate { Id = 0, Name = "New", NavigateTree = "/feature/new/", NavigatePath = "/new-application/", TitleHtml = "<i class=\"fas fa-plus-square\"></i> New Application", TitleLong = "Feature New - Create a New Application", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.New.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.New.html"), Sort = 0.25, SitemapDate = DateTime.Parse("2021-05-01 03:00", CultureInfo.InvariantCulture), IdName = "New" },
                    new ContentIntegrate { Id = 0, Name = "SSL Certificate", NavigateTree = "/install/ssl/", NavigatePath = "/ssl-certificate/", TitleHtml = "<i class=\"fab fa-expeditedssl\"></i> SSL Certificate", TitleLong = "Install and Order a SSL Cerificate with IIS", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.SSL Certificate.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.SSL Certificate.html"), Sort = 100, SitemapDate = DateTime.Parse("2021-04-30 03:50", CultureInfo.InvariantCulture), IdName = "SSL Certificate" },
                };
                return result;
            }
        }
