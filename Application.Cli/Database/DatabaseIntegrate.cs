        ...
        public static List<NavigateIntegrate> RowList
        {
            get
            {
                var result = new List<NavigateIntegrate>
                {
                    ...
                    new NavigateIntegrate { Id = 0, ParentId = 0, Name = "ar", TextHtml = null, IsDivider = false, IsNavbarEnd = false, IsContent = true, NavigatePath = null, PageTypeName = null, Sort = 1000, SitemapDate = null, IdName = "ar", ParentIdName = null },
                    new NavigateIntegrate { Id = 0, ParentId = 0, Name = "Architecture", TextHtml = "<i class=\"fas fa-ruler-combined\"></i> Architecture", IsDivider = false, IsNavbarEnd = false, IsContent = true, NavigatePath = "/architecture/", PageTypeName = null, Sort = 1000.5, SitemapDate = DateTime.Parse("2021-04-30 10:01", CultureInfo.InvariantCulture), IdName = "Architecture", ParentIdName = "Code" },
                    ...
                    new NavigateIntegrate { Id = 0, ParentId = 0, Name = "BuildServer", TextHtml = "<i class=\"fas fa-server\"></i> Build Server CI", IsDivider = false, IsNavbarEnd = false, IsContent = true, NavigatePath = "/feature-build-server/", PageTypeName = null, Sort = 1000.75, SitemapDate = DateTime.Parse("2021-04-29 08:24", CultureInfo.InvariantCulture), IdName = "BuildServer", ParentIdName = "Feature" },
                    ...
                    new NavigateIntegrate { Id = 0, ParentId = 0, Name = "Config", TextHtml = "<i class=\"fas fa-cog\"></i> Config", IsDivider = false, IsNavbarEnd = false, IsContent = true, NavigatePath = "/feature-config/", PageTypeName = null, Sort = 1000.5, SitemapDate = DateTime.Parse("2021-04-29 08:37", CultureInfo.InvariantCulture), IdName = "Config", ParentIdName = "Feature" },
                    ...
                    new NavigateIntegrate { Id = 0, ParentId = 0, Name = "Excel", TextHtml = "<i class=\"fas fa-file-excel\"></i> Excel", IsDivider = false, IsNavbarEnd = false, IsContent = true, NavigatePath = "/feature-excel/", PageTypeName = null, Sort = 1003, SitemapDate = DateTime.Parse("2021-04-29 08:25", CultureInfo.InvariantCulture), IdName = "Excel", ParentIdName = "Feature" },
                    ...
                    new NavigateIntegrate { Id = 0, ParentId = 0, Name = "Home", TextHtml = "<i class=\"fas fa-home\"></i> Home", IsDivider = false, IsNavbarEnd = false, IsContent = true, NavigatePath = "/", PageTypeName = null, Sort = 1001, SitemapDate = DateTime.Parse("2021-04-30 07:31", CultureInfo.InvariantCulture), IdName = "Home", ParentIdName = null },
                    ...
                    new NavigateIntegrate { Id = 0, ParentId = 0, Name = "Md", TextHtml = "<i class=\"fab fa-markdown\"></i> Markdown", IsDivider = false, IsNavbarEnd = false, IsContent = true, NavigatePath = "/feature-md-markdown/", PageTypeName = null, Sort = 1002.5, SitemapDate = DateTime.Parse("2021-04-29 05:11", CultureInfo.InvariantCulture), IdName = "Md", ParentIdName = "Feature" },
                    new NavigateIntegrate { Id = 0, ParentId = 0, Name = "Navigate", TextHtml = "<i class=\"far fa-compass\"></i> Navigate Request", IsDivider = false, IsNavbarEnd = false, IsContent = true, NavigatePath = "/feature-navigate-request/", PageTypeName = null, Sort = 1002.25, SitemapDate = DateTime.Parse("2021-04-30 09:49", CultureInfo.InvariantCulture), IdName = "Navigate", ParentIdName = "Feature" },
                    new NavigateIntegrate { Id = 0, ParentId = 0, Name = "New", TextHtml = "<i class=\"fas fa-plus-square\"></i> New Application", IsDivider = false, IsNavbarEnd = false, IsContent = true, NavigatePath = "/feature-new-application/", PageTypeName = null, Sort = 1000.25, SitemapDate = DateTime.Parse("2021-04-29 04:22", CultureInfo.InvariantCulture), IdName = "New", ParentIdName = "Feature" },
                    new NavigateIntegrate { Id = 0, ParentId = 0, Name = "SSL Certificate", TextHtml = "<i class=\"fab fa-expeditedssl\"></i> SSL Certificate", IsDivider = false, IsNavbarEnd = false, IsContent = true, NavigatePath = "/ssl-certificate/", PageTypeName = null, Sort = 1100, SitemapDate = DateTime.Parse("2021-04-29 08:34", CultureInfo.InvariantCulture), IdName = "SSL Certificate", ParentIdName = "Install" },
                };
                return result;
            }
        }
        ...
        public static List<NavigateRoleIntegrate> RowList
        {
            get
            {
                var result = new List<NavigateRoleIntegrate>
                {
                    ...
                    new NavigateRoleIntegrate { Id = 0, NavigateId = 0, LoginRoleId = 0, IsActive = true, NavigateIdName = "ar", LoginRoleIdName = "Guest" },
        ...
        public static List<ContentIntegrate> RowList
        {
            get
            {
                var result = new List<ContentIntegrate>
                {
                    ...
                    new ContentIntegrate { Id = 0, Name = "Blob", NavigateTree = "/feature/blob/", NavigatePath = "/feature-blob/", TitleHtml = "<i class=\"fas fa-splotch\"></i> Blob", TitleLong = "Feature Blob - Store SQL Data in External Files.", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Blob.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Blob.html"), Sort = 2, SitemapDate = DateTime.Parse("2021-04-30 03:48", CultureInfo.InvariantCulture), IdName = "Blob" },
                    new ContentIntegrate { Id = 0, Name = "BuildServer", NavigateTree = "/feature/build-server/", NavigatePath = "/feature-build-server/", TitleHtml = "<i class=\"fas fa-server\"></i> Build Server CI", TitleLong = "Feature Build Server - Continuous integration (CI)", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.BuildServer.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.BuildServer.html"), Sort = 0.75, SitemapDate = DateTime.Parse("2021-04-29 08:24", CultureInfo.InvariantCulture), IdName = "BuildServer" },
                    ...
                    new ContentIntegrate { Id = 0, Name = "Code Counter", NavigateTree = "/code/counter/", NavigatePath = "/counter/", TitleHtml = "<i class=\"fas fa-mouse\"></i> Counter", TitleLong = "Hello World Counter Example", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Code Counter.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Code Counter.html"), Sort = 2, SitemapDate = DateTime.Parse("2021-04-30 03:48", CultureInfo.InvariantCulture), IdName = "Code Counter" },
                    ...
                    new ContentIntegrate { Id = 0, Name = "Code Hello World", NavigateTree = "/code/hello-world/", NavigatePath = "/hello-world/", TitleHtml = "<i class=\"fas fa-globe\"></i> Hello World", TitleLong = "Hello World Code Example", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Code Hello World.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Code Hello World.html"), Sort = 1, SitemapDate = DateTime.Parse("2021-04-30 03:49", CultureInfo.InvariantCulture), IdName = "Code Hello World" },
                    new ContentIntegrate { Id = 0, Name = "Config", NavigateTree = "/feature/config/", NavigatePath = "/feature-config/", TitleHtml = "<i class=\"fas fa-cog\"></i> Config", TitleLong = "Feature Config - All Configuration", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Config.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Config.html"), Sort = 0.5, SitemapDate = DateTime.Parse("2021-04-30 03:48", CultureInfo.InvariantCulture), IdName = "Config" },
                    new ContentIntegrate { Id = 0, Name = "Excel", NavigateTree = "/feature/excel/", NavigatePath = "/feature-excel/", TitleHtml = "<i class=\"fas fa-file-excel\"></i> Excel", TitleLong = "Feature Excel Export and Import", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Excel.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Excel.html"), Sort = 3, SitemapDate = DateTime.Parse("2021-04-29 08:25", CultureInfo.InvariantCulture), IdName = "Excel" },
                    ...
                    new ContentIntegrate { Id = 0, Name = "Home", NavigateTree = "/", NavigatePath = "/", TitleHtml = "<i class=\"fas fa-home\"></i> Home", TitleLong = "Business Application Framework for ASP.NET Core 5.0 ", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Home.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Home.html"), Sort = 1, SitemapDate = DateTime.Parse("2021-04-30 03:47", CultureInfo.InvariantCulture), IdName = "Home" },
                    ...
                    new ContentIntegrate { Id = 0, Name = "Md", NavigateTree = "/feature/md/", NavigatePath = "/feature-md-markdown/", TitleHtml = "<i class=\"fab fa-markdown\"></i> Markdown", TitleLong = "Feature Markdown - Markdown parser", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Md.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Md.html"), Sort = 2.5, SitemapDate = DateTime.Parse("2021-04-29 05:11", CultureInfo.InvariantCulture), IdName = "Md" },
                    new ContentIntegrate { Id = 0, Name = "Navigate", NavigateTree = "/feature/navigate/", NavigatePath = "/feature-navigate-request/", TitleHtml = "<i class=\"far fa-compass\"></i> Navigate Request", TitleLong = "Feature Navigate - Navigate Request", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Navigate.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.Navigate.html"), Sort = 2.25, SitemapDate = DateTime.Parse("2021-04-30 03:49", CultureInfo.InvariantCulture), IdName = "Navigate" },
                    new ContentIntegrate { Id = 0, Name = "New", NavigateTree = "/feature/new/", NavigatePath = "/feature-new-application/", TitleHtml = "<i class=\"fas fa-plus-square\"></i> New Application", TitleLong = "Feature New - Create a New Application", TextMd = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.New.md"), TextHtml = Framework.Cli.UtilCli.BlobReadText("Doc.ContentIntegrate.New.html"), Sort = 0.25, SitemapDate = DateTime.Parse("2021-04-30 03:49", CultureInfo.InvariantCulture), IdName = "New" },
