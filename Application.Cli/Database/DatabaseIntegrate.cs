    ...
    public static class StorageFileIntegrateAppCli
    {
        public static List<StorageFileIntegrate> RowList
        {
            get
            {
                ...
                {
                    new StorageFileIntegrate { Id = 0, FileName = "cli.png", Data = Framework.Cli.UtilCliBlob.ReadData("Doc.StorageFileIntegrate.cli.png"), DataImageThumbnail = null, Description = null, SourceUrl = null, IsIntegrate = true, IsDelete = false, IdName = "cli.png" },
                    new StorageFileIntegrate { Id = 0, FileName = "counter.png", Data = Framework.Cli.UtilCliBlob.ReadData("Doc.StorageFileIntegrate.counter.png"), DataImageThumbnail = null, Description = null, SourceUrl = null, IsIntegrate = true, IsDelete = false, IdName = "counter.png" },
                    new StorageFileIntegrate { Id = 0, FileName = "data-grid.png", Data = Framework.Cli.UtilCliBlob.ReadData("Doc.StorageFileIntegrate.data-grid.png"), DataImageThumbnail = null, Description = null, SourceUrl = null, IsIntegrate = true, IsDelete = false, IdName = "data-grid.png" },
                    new StorageFileIntegrate { Id = 0, FileName = "data-grid-annotation.png", Data = Framework.Cli.UtilCliBlob.ReadData("Doc.StorageFileIntegrate.data-grid-annotation.png"), DataImageThumbnail = null, Description = null, SourceUrl = null, IsIntegrate = true, IsDelete = false, IdName = "data-grid-annotation.png" },
                    new StorageFileIntegrate { Id = 0, FileName = "db-to-data-grid.png", Data = Framework.Cli.UtilCliBlob.ReadData("Doc.StorageFileIntegrate.db-to-data-grid.png"), DataImageThumbnail = null, Description = null, SourceUrl = null, IsIntegrate = true, IsDelete = false, IdName = "db-to-data-grid.png" },
                    new StorageFileIntegrate { Id = 0, FileName = "excel-export.png", Data = Framework.Cli.UtilCliBlob.ReadData("Doc.StorageFileIntegrate.excel-export.png"), DataImageThumbnail = null, Description = null, SourceUrl = null, IsIntegrate = true, IsDelete = false, IdName = "excel-export.png" },
                    new StorageFileIntegrate { Id = 0, FileName = "hello-world.png", Data = Framework.Cli.UtilCliBlob.ReadData("Doc.StorageFileIntegrate.hello-world.png"), DataImageThumbnail = null, Description = null, SourceUrl = null, IsIntegrate = true, IsDelete = false, IdName = "hello-world.png" },
                    new StorageFileIntegrate { Id = 0, FileName = "iis.png", Data = Framework.Cli.UtilCliBlob.ReadData("Doc.StorageFileIntegrate.iis.png"), DataImageThumbnail = null, Description = null, SourceUrl = null, IsIntegrate = true, IsDelete = false, IdName = "iis.png" },
                    new StorageFileIntegrate { Id = 0, FileName = "pillar.png", Data = Framework.Cli.UtilCliBlob.ReadData("Doc.StorageFileIntegrate.pillar.png"), DataImageThumbnail = null, Description = null, SourceUrl = null, IsIntegrate = true, IsDelete = false, IdName = "pillar.png" },
                };
                return result;
            }
        }
    ...
    public static class ContentIntegrateAppCli
    {
        public static List<ContentIntegrate> RowList
        {
            get
            {
                ...
                {
                    new ContentIntegrate { Id = 0, Name = "About", NavigateTree = "/about/", NavigatePath = "/about/", TitleHtml = "<i class=\"fas fa-info-circle\"></i> About", TitleLong = "About WorkplaceX Framework", TextMd = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.About.md"), TextHtml = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.About.html"), Sort = 5, SitemapDate = DateTime.Parse("2021-04-22 10:40", CultureInfo.InvariantCulture), IdName = "About" },
                    new ContentIntegrate { Id = 0, Name = "Application", NavigateTree = "/install/app/", NavigatePath = "/install/", TitleHtml = "<i class=\"fas fa-window-maximize\"></i> Application", TitleLong = "Install Application from Scratch", TextMd = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Application.md"), TextHtml = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Application.html"), Sort = 21, SitemapDate = DateTime.Parse("2021-04-21 01:17", CultureInfo.InvariantCulture), IdName = "Application" },
                    new ContentIntegrate { Id = 0, Name = "Cli", NavigateTree = "/cli/", NavigatePath = "/cli/", TitleHtml = "<i class=\"fas fa-desktop\"></i> CLI", TitleLong = "Command Line Interface (CLI)", TextMd = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Cli.md"), TextHtml = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Cli.html"), Sort = 4, SitemapDate = DateTime.Parse("2021-04-21 01:15", CultureInfo.InvariantCulture), IdName = "Cli" },
                    new ContentIntegrate { Id = 0, Name = "Code", NavigateTree = "/code/", NavigatePath = "/code/", TitleHtml = "<i class=\"fas fa-code-branch\"></i> Code", TitleLong = null, TextMd = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Code.md"), TextHtml = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Code.html"), Sort = 3, SitemapDate = DateTime.Parse("2021-04-21 01:19", CultureInfo.InvariantCulture), IdName = "Code" },
                    new ContentIntegrate { Id = 0, Name = "Code Annotation", NavigateTree = "/code/annotation/", NavigatePath = "/annotation/", TitleHtml = "<i class=\"fas fa-asterisk\"></i> Annotation", TitleLong = "Grid Data Annotation", TextMd = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Code Annotation.md"), TextHtml = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Code Annotation.html"), Sort = 4, SitemapDate = DateTime.Parse("2021-04-22 10:44", CultureInfo.InvariantCulture), IdName = "Code Annotation" },
                    new ContentIntegrate { Id = 0, Name = "Code Counter", NavigateTree = "/code/counter/", NavigatePath = "/counter/", TitleHtml = "<i class=\"fas fa-mouse\"></i> Counter", TitleLong = "Hello World Counter Example", TextMd = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Code Counter.md"), TextHtml = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Code Counter.html"), Sort = 2, SitemapDate = DateTime.Parse("2021-04-22 10:44", CultureInfo.InvariantCulture), IdName = "Code Counter" },
                    new ContentIntegrate { Id = 0, Name = "Code Data Grid", NavigateTree = "/code/data-grid/", NavigatePath = "/data-grid/", TitleHtml = "<i class=\"fas fa-table\"></i> Data Grid", TitleLong = "From Database to DataGrid", TextMd = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Code Data Grid.md"), TextHtml = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Code Data Grid.html"), Sort = 3, SitemapDate = DateTime.Parse("2021-04-22 10:44", CultureInfo.InvariantCulture), IdName = "Code Data Grid" },
                    new ContentIntegrate { Id = 0, Name = "Code Hello World", NavigateTree = "/code/hello-world/", NavigatePath = "/hello-world/", TitleHtml = "<i class=\"fas fa-globe\"></i> Hello World", TitleLong = "Hello World Code Example", TextMd = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Code Hello World.md"), TextHtml = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Code Hello World.html"), Sort = 1, SitemapDate = DateTime.Parse("2021-04-22 10:15", CultureInfo.InvariantCulture), IdName = "Code Hello World" },
                    new ContentIntegrate { Id = 0, Name = "Excel", NavigateTree = "/excel/", NavigatePath = "/excel/", TitleHtml = "<i class=\"fas fa-file-excel\"></i> Excel", TitleLong = "Excel Export and Import", TextMd = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Excel.md"), TextHtml = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Excel.html"), Sort = 4.5, SitemapDate = DateTime.Parse("2021-04-22 10:33", CultureInfo.InvariantCulture), IdName = "Excel" },
                    new ContentIntegrate { Id = 0, Name = "Home", NavigateTree = "/", NavigatePath = "/", TitleHtml = "<i class=\"fas fa-home\"></i> Home", TitleLong = "Business Application Framework", TextMd = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Home.md"), TextHtml = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Home.html"), Sort = 1, SitemapDate = DateTime.Parse("2021-04-21 01:15", CultureInfo.InvariantCulture), IdName = "Home" },
                    new ContentIntegrate { Id = 0, Name = "IIS Server", NavigateTree = "/install/iis/", NavigatePath = "/iis/", TitleHtml = "<i class=\"fas fa-server\"></i> IIS Server", TitleLong = "Install on IIS Server", TextMd = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.IIS Server.md"), TextHtml = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.IIS Server.html"), Sort = 22, SitemapDate = DateTime.Parse("2021-04-23 09:49", CultureInfo.InvariantCulture), IdName = "IIS Server" },
                    new ContentIntegrate { Id = 0, Name = "Install", NavigateTree = "/install/", NavigatePath = null, TitleHtml = "<i class=\"fas fa-box-open\"></i> Install", TitleLong = null, TextMd = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Install.md"), TextHtml = Framework.Cli.UtilCliBlob.ReadText("Doc.ContentIntegrate.Install.html"), Sort = 2, SitemapDate = DateTime.Parse("2021-04-21 02:01", CultureInfo.InvariantCulture), IdName = "Install" },
                };
                return result;
            }
        }
