namespace Application.Doc
{
    ...
    public class PageFeedback : Page
    {
        ...
        {
            new Html(this) { TextHtml = "<h1 class='title'>Comment <i class='far fa-comment'></i></h1><p>Provide feedback to this page if you have any question regarding content or something should get updated.</p><div></div>" };
